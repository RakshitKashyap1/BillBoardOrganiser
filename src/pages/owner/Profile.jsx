...
import { User, Settings, Save, Mail, Briefcase, MapPin, Phone } from 'lucide-react';
...
export default function Profile() {
    ...
    const [formData, setFormData] = useState({
        name: user?.name || 'Media Owner Demo',
        email: user?.email || 'owner@bbo.com',
        company: 'Prime Billboards LLC',
        address: '456 Skyline Blvd, Chicago, IL',
    ...
    return (
        <div className="animate-fade-in">
            <div className="flex items-center gap-4 mb-8">
                <div className="stat-icon" style={{ background: 'var(--success)' }}><User size={24} color="#000" /></div>
                <h1 style={{ margin: 0 }}>Owner Profile</h1>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
                ...
                <div className="card h-full">
                    <div className="flex flex-col items-center text-center pb-6 border-b mb-6">
                        ...
                        <span className="badge badge-success mt-2">Media Owner</span>
                    </div>
